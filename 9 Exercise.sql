...
CREATE PROCEDURE GetEmployeeDetailsMiardi
@DepartmentID INT,
@MinSalary INT
AS
BEGIN
...
GRANT EXECUTE ON GetEmployeeDetailsMiardi TO User_B
REVOKE SELECT ON Employees TO User_A
...
CREATE PROCEDURE UpdateEmployeeSalaryMiardi 
 @EmployeeID INT,
 @NewSalary INT
 AS
 BEGIN
 ...
 EXEC UpdateEmployeeSalaryMiardi 
 @EmployeeID = 105, @NewSalary = 7500;
